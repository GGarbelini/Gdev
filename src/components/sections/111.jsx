    ...
    responsive: [
      ...
      },
      {
        ...
        settings: {
          slidesToShow: 1,
          slidesToScroll: 1,
          arrows: false, // Remover setas em telas pequenas pode ajudar
        centerMode: true, // Centralizar o slide visível
        centerPadding: '0px', // Sem padding para evitar slides parciais
        }
      }
    ]
  };
